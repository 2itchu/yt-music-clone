  ...
  const Navigator = ()=>{
    ...
    return (
      <div>
        <section className={"flex flex-col gap-2 p-4"}>
          {routes.map((route)=>{
            return <Link key={route.label} href={route.href}>
              <div className={cn("flex flex-row items-center gap-4 hover:bg-neutral-700 rounded-lg p-2", route.isActive && "bg-neutral-800")}>
                {route.icon}
        ...
        <section className={"px-6"}>
          <div className={"flex flex-row items-center bg-neutral-800 my-6 rounded-3xl p-2 font[300] justify-center gap-2 cursor-pointer hover:bg-neutral-700"}>
